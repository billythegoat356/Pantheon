...
print(Col.orange+center("   Pantheon - The fastest Youtube Music downloader.")+Col.white)

print("\n\n")

music = input(Col.yellow+"Music name > "+Col.white)
music += "Music"


video_url = Dorks.youtube_search(music)[0]
...
if not video_title:
    input(Col.red+"No music found!"+Col.white)
    exit()
